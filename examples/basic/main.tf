...
# The rwx_self_hosted_runner_label, rwx_self_hosted_runner_external_id, and
# rwx_aws_account_id values below are provided by RWX when you configure a
# self-hosted runner — copy them directly from the runner setup page at
# cloud.rwx.com. The subnet_ids and security_group_ids reference resources in
