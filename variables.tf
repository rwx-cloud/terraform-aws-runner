...
variable "external_id" {
  ...
  validation {
    condition     = can(regex("^[0-9a-f]{32}$", var.external_id))
...
variable "rwx_account_id" {
  ...
  validation {
    condition     = can(regex("^[0-9]{12}$", var.rwx_account_id))
